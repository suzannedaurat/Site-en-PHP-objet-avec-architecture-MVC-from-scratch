...
<html>
    ...
    <body>
        ...
        <h1 id="titreBlog">DAT BLOG BITCH - WRITERS MODE</h1>
    ...
    <button type=submit name ="Submit">Submit</button>
        ...
        <p></html><?php if(Session::read('username') !== null) echo "Welcome " . Session::read('username') . ", ready to write ?"?><html></p><br></html>
